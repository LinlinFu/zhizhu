...
class TestFeedbackViewController: BaseViewController {
    ...
    func buildTableView() {
        ...
        tableView.register(UINib(nibName: "FeedbackNormalCell", bundle: nil), forCellReuseIdentifier: "FeedbackNormalCell")
...
extension TestFeedbackViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "FeedbackNormalCell") as! FeedbackNormalCell
        cell.updateFeekbackData(topString: topString, model: dataModel, indexpath: indexPath)
